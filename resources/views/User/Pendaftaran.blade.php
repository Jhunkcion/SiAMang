...
<body>
    ...
    <div class="main-container">
                ...
                <div class="carousel-section">
                    ...
                    <div class="carousel-container">
                        <div class="carousel-item">
                            <img src="{{ asset(path: 'bootslander/assets/img/gallery/gallery-1.jpg') }}"
                                alt="Magang Periode Sebelumnya">
                            <div class="carousel-caption">Presentasi Proyek Magang</div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('bootslander/assets/img/gallery/gallery-2.jpg') }}"
                                alt="Magang Periode Sebelumnya">
                            <div class="carousel-caption">Workshop Pengembangan</div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('bootslander/assets/img/gallery/gallery-3.jpg') }}"
                                alt="Magang Periode Sebelumnya">
        ...
        <div class="card">
            ...
            <div class="status-progress">
                <div class="progress-container">
                    <div
                        class="progress-step {{ $pendaftaran->status == 'pending' || $pendaftaran->status == 'diterima' || $pendaftaran->status == 'ditolak' ? 'active' : '' }}">
                        <div class="step-icon"><i class="fas fa-paper-plane"></i></div>
                        <div class="step-label">Terkirim</div>
                    </div>
                    <div class="progress-line"></div>
                    <div
                        class="progress-step {{ $pendaftaran->status == 'diterima' || $pendaftaran->status == 'ditolak' ? 'active' : '' }}">
            ...
            <div class="info-section">
                ...
                <div class="form-group">
                    ...
                    <p>{{ \Carbon\Carbon::parse($pendaftaran->tanggal_mulai)->diffInDays(\Carbon\Carbon::parse($pendaftaran->tanggal_selesai)) + 1 }}
                        hari</p>
                </div>
            </div>
                    ...
                    <div class="document-box">
                        ...
                        <div class="document-info">
                            ...
                            <div class="document-actions">
                                <a href="{{ route('view.pdf', Crypt::encryptString($pendaftaran->id)) }}"
                                    target="_blank" class="btn btn-sm btn-outline">
                                    <i class="fas fa-eye"></i> Lihat
                                </a>
                                <a href="{{ asset('storage/' . $pendaftaran->surat_pengantar) }}" download
                ...
                <div class="form-group">
                    <div class="status-box {{ $pendaftaran->status }}">
                        ...
                        <div class="status-details">
                            ...
                            <div class="submission-date">
                                <i class="fas fa-calendar-check"></i> Diterima pada:
                                {{ \Carbon\Carbon::parse($pendaftaran->updated_at)->format('d M Y H:i') }}
                            </div>
                            ...
                            <div class="acceptance-info">
                                ...
                                <ol>
                                    <li>Datang pada tanggal
                                        {{ \Carbon\Carbon::parse($pendaftaran->tanggal_mulai)->format('d M Y') }} pukul
                                        08.00 WIB</li>
                        ...
                        <div class="status-details">
                            ...
                            <div class="submission-date">
                                <i class="fas fa-calendar-times"></i> Ditolak pada:
                                {{ \Carbon\Carbon::parse($pendaftaran->updated_at)->format('d M Y H:i') }}
                            </div>
                            <a href="{{ route('hapus.pendaftaran', $pendaftaran->id) }}"
                                class="btn btn-primary mt-3">Ajukan Pendaftaran Ulang</a>
                        </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <form action="{{ route('form.pendaftaran') }}" method="POST" enctype="multipart/form-data"
                id="form-pendaftaran">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="select-container">
                        ...
                        <input type="text" class="form-control" id="asal-kampus-manual" name="asal_kampus"
                            placeholder="Ketik nama kampus" required>
                        @error('asal_kampus')
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-container">
                        <label class="file-input-label">
                            ...
                            <input type="file" class="file-input" name="surat_pengantar" accept="application/pdf"
