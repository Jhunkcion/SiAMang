...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="note">
                <strong>Catatan Keamanan:</strong> Jangan pernah membagikan kode OTP Anda kepada siapapun, termasuk
                pihak yang mengaku sebagai staf kami.
            </div>
        </div>

        <div class="footer">
            <p>&copy; 2025 Sistem Pendaftaran magang. Seluruh hak cipta dilindungi.</p>
            <p>Jika Anda mengalami kesulitan, silakan hubungi <a
