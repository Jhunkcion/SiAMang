...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>© 2025 Jhunkcion. Semua hak dilindungi.</p>
            <div class="contact-info">
                <p>Jika Anda memiliki pertanyaan, silakan hubungi kami di <a href="mailto:ahmadpribadiaditya@.com">ahmadpribadiaditya@.com</a></p>
            </div>
        </div>
    </div>
</body>
