...
class PendaftaranController extends Controller
{
    ...
    // Mencetak data pendaftaran bulanan (untuk admin)
    public function printMonthly($year, $month)
    {
        try {
            // Ambil pendaftaran yang tanggal_mulai atau tanggal_selesai berada di bulan dan tahun yang dipilih
            $pendaftaranMagangs = PendaftaranMagang::with('anggota', 'user')
            ...
            return view('admin.cetak-pendaftaran-bulanan', compact('pendaftaranMagangs', 'year', 'month'));
        } catch (\Exception $e) {
            Log::error('Error saat mencetak data bulanan: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Terjadi kesalahan saat mencetak data pendaftaran bulanan.');
        }
    }
}