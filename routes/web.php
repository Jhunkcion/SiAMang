...
Route::middleware(['auth'])->group(function () {
    ...
    // Tambahkan route untuk print bulanan
    Route::get('/pendaftaran/print-monthly/{year}/{month}', [PendaftaranController::class, 'printMonthly'])
        ->name('pendaftaran.printMonthly');

    // Route to view PDF
    Route::get('/view-pdf/{encryptedId}', [PendaftaranController::class, 'viewPdf'])->name('view.pdf');
